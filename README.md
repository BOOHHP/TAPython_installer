...
> **推荐下载 `v1.5.0` 或更新版本。** `v1.5.0` 是首个支持应用内一键自更新的版本；从该版本开始，后续更新可以直接在左下角 Installer 面板中点击 **更新** 完成下载、替换和自动重启。
...
- **深色安装工作台**
  ...
  - 左下角 Installer 更新面板显示当前版本、远端最新版本和更新状态，并提供主动检查与一键自更新按钮
...
6. 左下角 Installer 面板会自动检查安装器自身版本；也可以点击 **检查** 主动复查，检测到新版后点击 **更新** 下载新版、替换当前程序并自动重启
...
> **Recommended download: `v1.5.0` or newer.** `v1.5.0` is the first release with in-app one-click self-update support. Starting from this version, future updates can be downloaded, replaced, and relaunched directly from the bottom-left Installer panel.
...
- **Dark installer workspace**
  ...
  - Bottom-left Installer update panel shows the current version, latest remote version, and update status, with separate manual check and one-click self-update buttons
...
6. The bottom-left Installer panel checks the app version automatically; click **Check** to refresh manually, then **Update** to download the new executable, replace the current app, and restart automatically
