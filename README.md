...
> **推荐下载 `v1.6.0` 或更新版本。** `v1.5.0` 是首个支持应用内一键自更新的版本；`v1.6.0` 开始，“脚本工具”页支持项目工具导入、导出和删除。
...
> **Recommended download: `v1.6.0` or newer.** `v1.5.0` is the first release with in-app one-click self-update support. Starting from `v1.6.0`, the Script Tools page supports project tool import, export, and deletion.
