...
- **深色安装工作台**
  ...
  - 左下角 Installer 更新面板显示当前版本、远端最新版本和更新状态，并提供主动检查与跳转更新按钮
...
6. 左下角 Installer 面板会自动检查安装器自身版本；也可以点击 **检查** 主动复查，检测到新版后点击 **更新** 打开最新 Release 页面
...
- **Dark installer workspace**
  ...
  - Bottom-left Installer update panel shows the current version, latest remote version, and update status, with separate manual check and update buttons
...
6. The bottom-left Installer panel checks the app version automatically; click **Check** to refresh manually, then **Update** to open the latest Release page when a newer version is available
