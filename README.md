...
> **推荐下载 `v1.8.1` 或更新版本。** `v1.5.0` 是首个支持应用内一键自更新的版本；`v1.6.0` 开始，“脚本工具”页支持项目工具导入、导出和删除；`v1.7.0` 新增应用内中文更新日志窗口；`v1.8.0` 新增 `tapython-generator` 与 `ue-api-navigator` Agent Skills 一键部署，并显著压缩单文件 EXE 体积；`v1.8.1` 开始，客户端会在本机首次打开当前版本时自动展示更新日志。
